...
class PointPillarLoss(nn.Module):
    ...
    def forward(self, output_dict, target_dict):
        ...
        psm = output_dict['psm'] # [B, 2, 50, 176] , channel 0 is foreground, channel 1 is background
        ...
        cls_targets = box_cls_labels # [B, 50*176*2]
        ...
        cls_preds = cls_preds.view(psm.shape[0], -1, 1) # [B, C*H*W, 1]
        one_hot_targets = one_hot_targets[..., 1:]

        cls_loss_src = self.cls_loss_func(cls_preds, # [B, C*H*W, 1]
                                          one_hot_targets, # [B, C*H*W, 1]
