...
from opencood.models.fuse_modules.mean_fuse import MeanFusion

from icecream import ic


class PointPillarMean(nn.Module):
    def __init__(self, args):
        super(PointPillarMean, self).__init__()
        ...
        self.fusion_net = MeanFusion(args['v2vfusion'])
