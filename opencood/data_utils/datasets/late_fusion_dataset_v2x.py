...
class LateFusionDatasetV2X(late_fusion_dataset.LateFusionDataset):
    """
    ...
    def get_item_train(self, base_data_dict):
        """
            We only choose ego for v2x-sim 2.0.

            Because agent have been shuffled
        """
        base_data_dict = add_noise_data_dict(base_data_dict, self.params['noise_setting'])
        processed_data_dict = OrderedDict()
        selected_cav_base = base_data_dict[0] # 0 is ego
